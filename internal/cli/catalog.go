...
func catalogExtras() map[string]CommandSpec {
	return map[string]CommandSpec{
		...
		"market":        {Group: GroupMarkets, Flags: flags(valueFlag("symbol", nil), valueFlag("range", []string{"1D", "5D", "1M", "6M", "YTD", "1Y", "5Y"}), valueFlag("exchange", nil), valueFlag("type", []string{"STK", "IND", "CASH"}), valueFlag("currency", nil), boolFlag("json"))},
		...
		"macro":         {Group: GroupMarkets, Brief: "Economic releases and official publications with source coverage", Flags: flags(boolFlag("json"))},
